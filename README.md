...
Changes:
  * Added support for the SQR Signal which is needed by the C128 Core for **Fast Serial**  
  ...
  * Removed 5V support which need a Standard SNAC Adapter connected before SNAC2IEC  
